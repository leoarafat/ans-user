...
import { commonStyles, commonStylesTwo } from "./CommonStyles";
...
const DetailsForm = ({
  ...
  return (
    <>
      ...
      <Grid item xs={6}>
        <FormControl fullWidth variant="filled" sx={commonStylesTwo}>
          ...
          <Controller
            ...
            control={control}
            render={({ field }) => (
              <Select {...field} labelId="explicit-label" label="Explicit">
